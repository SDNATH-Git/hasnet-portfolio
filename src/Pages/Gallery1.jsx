...
const importAllImages = () => {
    const images = import.meta.glob("../assets/gallery1/*.jpg", { eager: true });
...
const Gallery1 = () => {
    ...
    return (
        <div className="px-5 md:px-10 py-12">
            ...
            >
                Explore our students’ collaborative efforts, team projects, and leadership highlights.
            </motion.p>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 gap-2">
                {images.map((img, idx) => (
                    <motion.div
                        key={idx}
                        className="relative overflow-hidden rounded-xl border-2 border-[#25a244] shadow-lg cursor-pointer"
