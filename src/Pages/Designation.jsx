...
import photoUrl from "../assets/pic.png";
        ...
        <section className="text-white flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen px-5 md:px-5 lg:px-10 py-30 gap-10 lg:gap-20">
            ...
            >
                ...
                <motion.h1
                    ...
                    className="text-4xl md:text-5xl font-extrabold mb-2 text-[#25a244]"
                >
                    Abul Hasnat
                </motion.h1>
                ...
                <motion.p
                    variants={textVariant}
                    className="text-gray-200 mb-8 leading-relaxed text-sm md:text-base"
                >
                    I am a hardworking, honest individual.i am always willing to learn new skill. I am friendly, helpful and polite, have a good sense of humour. I am able to work independently in busy environments and also within a team setting. I am a good timekeeper.l am outgoing and tactful, and able to listen effectively when solving problems.
                </motion.p>
            ...
            <motion.div
                ...
                whileHover={{ scale: 1.05, rotate: 5, boxShadow: "0 20px 40px rgba(37, 162, 68, 0.7)" }}
            >
                <img
                    src={photoUrl}
                    alt="SD NATH"
